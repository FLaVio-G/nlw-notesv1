...
export function NewNoteCard({ onNoteCreated }: NewNoteCardprops) {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger className="rounded-md flex flex-col gap-5 text-left bg-slate-700 p-5  hover:ring-2 outine-none hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
      ...
      <Dialog.Portal>
        ...
        overflow-hidden 
         md:max-w-[640px] md:h-[640px]  bg-slate-700 md:rounded-md flex flex-col outline-none "
        >
